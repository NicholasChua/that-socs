...
def main():
    ...
    # with open("example_data/ip_virustotal_result.json", "w") as f:
    #     json.dump(vt_ip_data, f, indent=4)
    # with open("example_data/file_hash_virustotal_result.json", "w") as f:
    #     json.dump(vt_file_data, f, indent=4)
    # with open("example_data/domain_virustotal_result.json", "w") as f:
    #     json.dump(vt_domain_data, f, indent=4)
    # with open("example_data/abuseipdb_result.json", "w") as f:
    #     json.dump(abuse_data, f, indent=4)
    # with open("example_data/ipinfo_result.json", "w") as f:
    #     json.dump(ipinfo_data, f, indent=4)

    # Test data normalization

    # # Load previously saved data
    # with open("example_data/abuseipdb_result.json", "r") as f:
    #     abuse_data = json.load(f)
    # with open("example_data/ipinfo_result.json", "r") as f:
    #     ipinfo_data = json.load(f)
    # with open("example_data/ip_virustotal_result.json", "r") as f:
    #     vt_ip_data = json.load(f)
    # with open("example_data/file_hash_virustotal_result.json", "r") as f:
    #     vt_file_data = json.load(f)
    # with open("example_data/domain_virustotal_result.json", "r") as f:
    ...
    # with open("example_data/normalized_abuseipdb.json", "w") as f:
    #     json.dump(abuseipdb_normalized.__dict__, f, indent=4)
    # with open("example_data/normalized_ipinfo.json", "w") as f:
    #     json.dump(ipinfo_normalized.__dict__, f, indent=4)
    # with open("example_data/normalized_ip_virustotal.json", "w") as f:
    #     json.dump(virustotal_ip_normalized.__dict__, f, indent=4)
    # with open("example_data/normalized_file_hash_virustotal.json", "w") as f:
    #     json.dump(virustotal_file_hash_normalized.__dict__, f, indent=4)
    # with open("example_data/normalized_domain_virustotal.json", "w") as f:
    #     json.dump(virustotal_domain_normalized.__dict__, f, indent=4)

    # Test enrichment

    # Load previously saved data
    # with open("example_data/normalized_abuseipdb.json", "r") as f:
    #     abuse_data = json.load(f)
    # with open("example_data/normalized_ipinfo.json", "r") as f:
    #     ipinfo_data = json.load(f)
    # with open("example_data/normalized_ip_virustotal.json", "r") as f:
    #     vt_ip_data = json.load(f)
    # with open("example_data/normalized_file_hash_virustotal.json", "r") as f:
    #     vt_file_data = json.load(f)
    # with open("example_data/normalized_domain_virustotal.json", "r") as f:
    #     vt_domain_data = json.load(f)
